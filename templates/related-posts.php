<?php 
global $post;
$blog_thumb_size = 'reebox_blog_thumb';
...
?>
	<div class="ts-blogs ts-shortcode related-posts related ts-slider <?php echo esc_attr($is_slider?'loading':''); ?>">
		<header class="theme-title">
			<h3 class="heading-title"><?php esc_html_e('Related Posts', 'reebox'); ?></h3>
		</header>
							...
							<header>
								...
								<div class="entry-meta-top">
									...
									<span class="vcard author">
										<span><?php esc_html_e('By', 'reebox'); ?></span>
									...
									<!-- Blog Comment -->
									<?php if( function_exists('reebox_get_post_comment_count') ): ?>
									<span class="comment-count">
										<?php echo  reebox_get_post_comment_count(); ?>
									</span>
									<?php endif; ?>
